Na lista de exercícios desta aula, vamos revisar todo o conteúdo do curso.

A revisão de conteúdo é uma etapa essencial para exercitar suas habilidades de memória e, o mais importante, resolução de problemas práticos.

Exercícios
Vamos propor um exercício interessante! A sua missão será construir um programa de registro e cálculo de notas escolares. Cada exercício será um passo na construção desse programa. Lembre-se de testar o seu código conforme você o desenvolve, corrigindo possíveis erros.
...
Assim como fizemos na aplicação de notas (no sentido de anotações), personalize o menu da aplicação com ASCII art. Você pode estilizar a ASCII art com “Sistema de acompanhamento escolar” ou algo assim. Você pode utilizar esta ferramenta online.
