...
String capturarOperacaoUsuario() {
  ...
  if (!operacoes.contains(entrada)) {
    print("Operação $entrada inválida, escolha entre ${operacoes.toString()}");
    return capturarOperacaoUsuario();
  }
  return entrada;
}
